...
現在の要求に対応する実データ公開は **Mona新版1.2・1.5・3倍、Copilot全5倍率、Ducky 1.2倍の9/15案**です。Copilot 1.2倍は目標21,448に対し
...
固定1倍9,669部品に対する比較で、旧r3の413部品とは混同しません。残るDucky 4倍率案は未完了です。
...
全実案の6列・実寸比sheetと15行CSVは、3体すべての実制作物がそろった後の固定補完を待っています。未完の案を代理画像で埋めません。
