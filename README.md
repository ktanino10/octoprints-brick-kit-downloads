...
Mona・Copilot・Rubber Duckyを約180 mmの独立ブリックで組み立てる、非商用の試作記録です。
...
**Mona支台なし新版・Copilot・Rubber Duckyの全15実案**について、CG・動画・Blender・ネイティブCAD・BOM・実3D組立ガイドを配布しています。
...
Rubber Duckyの最初の倍率案は **1.2倍・11,586部品（目標11,603、差−17）・93型・311.8 × 455.8 × 397.0 mm・仮支持0**。
固定1倍9,669部品に対する比較で、旧r3の413部品とは混同しません。全5案の仮支台数は **0 / 0 / 3 / 0 / 1**。
Rubber Ducky 2倍は実19,309個とは別に支台3個、4倍は実38,473個とは別に支台1個をCG・動画・CADにも保持します。
支台が隣接して一本に見えても別IDです。ガイドには実部品IDと実組立step、支持高さを示し、保持力・安定性の実物確認前の撤去を禁止しています。
印刷時のスライサーsupport要否は別の未検証条件です。
Mona・Copilot・Rubber Duckyの1倍基準は、CG・ネイティブCAD・Blender・3章動画を別の参照パッケージとして公開しました。
...
1倍の個数はMona 12,435 / Copilot 17,873 / Rubber Ducky 9,669。3体を初期Fine Cに近い8 mm共通ブロックへそろえる
...
| Rubber Ducky | 413 | 522（+109） | 413（増減0） |
...
| 選定r2 | Mona Fine 4 mm / Copilot Chunky 8 mm / Rubber Ducky Fine 4 mm。画像3枚・Blender 3シーン・動画3本・BOM・組立候補・部品ID |
...
選定r2の部品数は **Mona 13,434 / Copilot 3,021 / Rubber Ducky 10,311**。
